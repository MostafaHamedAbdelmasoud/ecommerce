...
<!-- <a href="{{url('/shop/'.$product->slug)}}"> -->
						<img src="{{asset('assets/images/'.$product->slug.'.jpg')}}" alt="IMG-BANNER">

						<a href="{{url('/shop/'.$product->slug)}}" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
