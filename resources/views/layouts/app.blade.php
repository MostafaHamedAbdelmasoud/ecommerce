			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<div class="wrap-icon-header flex-w flex-r-m">
						...
						<div class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti js-show-cart" data-notify="{{Cart::instance('default')->count()>0?Cart::instance('default')->count():NULL}}">
...
<!-- 	
	<script src="https://www.paypal.com/sdk/js?client-id=AWsIvjARhzGfULCjgR1_RiTu17t-KCNv6qsllZS3O1fm1G7SA2_-crd9quQbEYIKWMm3gMsjh1Cb8wYr">
  </script> -->
